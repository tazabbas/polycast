    ...
    <main style={{ fontFamily: 'sans-serif', background: '#FFFFFF', minHeight: '100vh', color: '#1A1A1A', overflowX: 'hidden' }}>
      ...
      <section style={{ position: 'relative', padding: '4rem 2rem', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '1200px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ color: '#6B6B76', marginBottom: '2.5rem' }}>Bundled lip sync minutes included — extra credits available any time.</p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.5rem', marginBottom: '2rem' }}>
            ...
            <div style={{ background: '#F7F7F8', border: '1px solid #E5E5EA', borderRadius: '16px', padding: '2rem', textAlign: 'left' }}>
              ...
              <p style={{ fontSize: '0.85rem', color: '#6B6B76', marginBottom: '1.5rem' }}>3 min lip sync/mo · getting started</p>
            ...
            <div style={{ background: '#EAF7F1', border: '2px solid #1D9E75', borderRadius: '16px', padding: '2rem', position: 'relative', textAlign: 'left' }}>
              ...
              <p style={{ fontSize: '0.85rem', color: '#6B6B76', marginBottom: '1.5rem' }}>8 min lip sync/mo · all 3 platforms</p>
            ...
            <div style={{ background: '#F2F0FC', border: '1px solid #533AB7', borderRadius: '16px', padding: '2rem', position: 'relative', textAlign: 'left' }}>
              ...
              <p style={{ fontSize: '0.85rem', color: '#6B6B76', marginBottom: '1.5rem' }}>20 min lip sync/mo · all 37 languages</p>
            ...
            <div style={{ background: '#FFFFFF', border: '1px solid #1D9E75', borderRadius: '16px', padding: '2rem', textAlign: 'left' }}>
              ...
              <p style={{ fontSize: '0.85rem', color: '#6B6B76', marginBottom: '1.5rem' }}>Pay-as-you-go lip sync · ad campaigns</p>
              <Link href="/pricing#business" style={{ display: 'block', background: 'transparent', color: '#1D9E75', border: '1px solid #1D9E75', padding: '0.75rem', borderRadius: '8px', textAlign: 'center', textDecoration: 'none', fontSize: '0.9rem', fontWeight: 600 }}>
                View plan
              </Link>
            </div>
